...
export class AuthService {
  ...
  async login(loginInput: LoginInput) {
    try {
      ...
      if (!existsUser) throw new BadRequestException('Email/password incorrectos');

      if (!encrypter.compareSync(password, existsUser.password)) throw new BadRequestException('Email/password incorrectos');
